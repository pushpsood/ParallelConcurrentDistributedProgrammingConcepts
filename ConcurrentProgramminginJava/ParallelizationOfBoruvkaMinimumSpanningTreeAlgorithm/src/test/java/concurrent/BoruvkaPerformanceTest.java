...
import concurrent.boruvka.parallel.ParBoruvka;
import concurrent.boruvka.parallel.ParBoruvkaFactory;
import concurrent.boruvka.sequential.SeqBoruvka;
import concurrent.boruvka.sequential.SeqBoruvkaFactory;
import concurrent.boruvka.Component;
...
public class BoruvkaPerformanceTest extends TestCase {
    /**
     * Test can fail based on number of threads, change the expectedSpeedup accordingly
     */
    static final double expectedSpeedup = 1.4;
