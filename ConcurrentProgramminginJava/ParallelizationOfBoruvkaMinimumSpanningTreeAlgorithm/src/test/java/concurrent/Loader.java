...
import concurrent.util.IntPair;
...
/**
 * The Loader class is responsible for reading edges from a provided input file
 * and loading them into a queue of components. It supports reading compressed
 * files and processes the graph data to create components and edges.
 */
