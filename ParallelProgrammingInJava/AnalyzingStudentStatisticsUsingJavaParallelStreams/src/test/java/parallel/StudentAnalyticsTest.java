...
/**
 * Test class for StudentAnalytics.
 */
public class StudentAnalyticsTest extends TestCase {
    ...
    /**
     * Generates an array of Student data.
    ...
    /**
     * Helper method to calculate the average age of enrolled students.
     * @param repeats the number of times to repeat the calculation
     * @return the speedup of the parallel version compared to the sequential version
     */
    ...
    /**
     * Helper method to find the most common first name of inactive students.
     * @param repeats the number of times to repeat the calculation
     * @return the speedup of the parallel version compared to the sequential version
     */
    ...
    /**
     * Helper method to count the number of failed students older than 20.
     * @param repeats the number of times to repeat the calculation
     * @return the speedup of the parallel version compared to the sequential version
     */
